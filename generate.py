...
RUBRO_MAP = {
    "frutos secos":"frutos","frutos":"frutos","cereales":"cereales",
    "semillas":"semillas","harinas":"harinas","granos":"granos",
    "granos y legumbres":"granos","legumbres":"granos","especias":"especias",
    "deshidratados":"deshidratados","dulces":"dulces",
    "dulces miel y chocolates":"dulces","miel":"dulces","chocolates":"dulces",
    "infusiones":"infusiones","infusiones y hierbas":"infusiones","hierbas":"infusiones",
    "suplementos":"suplementos","aceites":"aceites","aceites y vinagres":"aceites",
    "vinagres":"aceites","reposteria":"reposteria","repostería":"reposteria",
    "azucar cacao y reposteria":"reposteria","sin tacc":"sintacc","sin gluten":"sintacc",
    "snacks":"snack","snack":"snack","gourmet":"gourmet","linea gourmet":"gourmet",
    "línea gourmet":"gourmet","bebidas":"bebidas","encurtidos":"encurtidos",
    "aceitunas":"aceitunas","frio":"frio","productos de frio":"frio","frío":"frio",
    "congelados":"congelados","vinos":"vinos","vinos y licores":"vinos",
    "home":"home","paladear home":"home","tomate":"tomate",
    "mantecas":"mantecas","mantecas y pastas":"mantecas",
}

ICONO_MAP = {
    "frutos":"mix","cereales":"granola","semillas":"semillas_mix","harinas":"harina",
    "granos":"garbanzos","especias":"especias","deshidratados":"datil","dulces":"miel",
    "infusiones":"te_verde","suplementos":"colageno","aceites":"aceite_oliva",
    "reposteria":"cacao","sintacc":"semillas_mix","snack":"barra","gourmet":"tahine",
    "bebidas":"kombucha","encurtidos":"pepinillos","aceitunas":"aceitunas",
    "frio":"yoghurt","congelados":"arandanos_cong","vinos":"vino","home":"home",
    "tomate":"especias","mantecas":"mantequilla_mani",
}
...
def construir_prods(filas):
    ...
    for fila in filas:
        ...
        if "," in nombre:
            ...
            marca = "Granel"
        prods.append([id_counter, rubro, nombre_limpio, marca, unidad, False, icono, {opcion: [precio_min, precio_may]}])
        id_counter += 1
    return prods
